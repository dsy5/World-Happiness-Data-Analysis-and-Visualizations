...
description: |
  ...
  What is the Life Ladder Score?
  
  The Life Ladder is based on the Cantril Ladder Score (on a scale of 10), a higher life ladder score indicates a better life, while a lower score indicates a worse life.
...
In this graph, we can see that countries in Western Europe have high GDP per capitas and high life ladder scores (as seen in the top-right corner of the graph). Countries in the bottom-left corner, including those from Sub-Saharan Africa and South Asia, have lower GDP per capitas and lower life ladder scores. 
...
Similar to the graph above, we can see that countries in Western Europe and North America and ANZ have more freedom to make life choices and have access to more social support. Countries in the bottom-left corner have less freedom and social support. 
